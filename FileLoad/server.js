...
const removeImg = require('./Router/removeImg')
const recycleImg = require('./Router/recycleImg')
const myLoveImg = require('./Router/myLoveImg')
const showLoveImg = require('./Router/showLoveImg')
const pictureDownload = require('./Router/pictureDownload')
